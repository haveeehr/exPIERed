...
struct CategoryView: View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 15) {
            ...
            HStack(spacing: 15) {
                CategoryFieldComponent(imageComponent: "carrot.fill", elementNumber: countProductCategory(productList: products, filterCategory: [.greens]), categoryName: "Greens", callFunction: {
                    chosenFoodCategory = [.greens]
                    moveToListView = true
                })
            ...
            CategoryFieldComponent(imageComponent: "refrigerator.fill", elementNumber: products.count, categoryName: "All", callFunction: {
                chosenFoodCategory = [.fish, .meat, .greens, .others]
                moveToListView = true
            })
        }
    }
